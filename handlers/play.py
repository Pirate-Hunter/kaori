...
async def selfwelc(client: Client, message: Message):
  for user in message.new_chat_members:
    if user.id == 1704447681:
      await message.reply_text("Yayy, a new adventure, cant wait to play!!")
...
@Client.on_message(filters.command(["queue", "queue@KaoriMiyazonoRobot"]) & other_filters)
@errors
...
async def que(client: Client, message: Message):
  ...
  tex += "**"
  print(tex) 
  markup = InlineKeyboardMarkup([[InlineKeyboardButton(text = "Check Private!", url = "https://t.me/KaoriMiyazonoRobot")]])
...
@Client.on_message(filters.command(["start", "start@KaoriMiyazonoRobot"]) & other_filters)
@errors
async def startgrp(_, message: Message):
  await message.reply_text("Im awake and runnin' perfectly!!")
  
@Client.on_message(filters.command(["help", "help@KaoriMiyazonoRobot"]) & other_filters)
@errors
async def helpgrp(_, message: Message):
  markup = InlineKeyboardMarkup([[InlineKeyboardButton(text = "Help", url = "t.me/KaoriMiyazonoRobot?start=help")]])
  await message.reply_text("Yess!!, get to know me in my pm!", reply_markup = markup)

@Client.on_message(filters.command(["play", "play@KaoriMiyazonoRobot"]) & other_filters)
@errors
@authorized_users_only
async def play(_, message: Message):
    ...
    if audio:
        ...
        text += "**Playin[   ](https://telegra.ph/file/9f526179ad29913a67bdb.jpg)**"
